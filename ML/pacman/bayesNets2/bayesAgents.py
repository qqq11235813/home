...
def constructBayesNet(gameState):
    ...
    for housePos in gameState.getPossibleHouses():
        for obsPos in gameState.getHouseWalls(housePos):
            ...
            edges.append((FOOD_HOUSE_VAR,obsVar));edges.append((GHOST_HOUSE_VAR,obsVar))
            variableDomainsDict[obsVar] = OBS_VALS
            #print obsVar,obsPos,OBS_VAR_TEMPLATE,housePos

    variableDomainsDict[X_POS_VAR] = X_POS_VALS
    variableDomainsDict[Y_POS_VAR] = Y_POS_VALS
    variableDomainsDict[FOOD_HOUSE_VAR] = gameState.getPossibleHouses()
    variableDomainsDict[GHOST_HOUSE_VAR] = gameState.getPossibleHouses()
